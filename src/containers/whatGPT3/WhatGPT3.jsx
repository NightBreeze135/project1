  ...
  return (
    <div className="gpt3__whatgpt3 section__margin" id="wgpt3">
      <div className="gpt3__whatgpt3-feature">
        <Feature 
          title="What is GPT-3"
          text="We so opinion friends me message as delight. Whole front do of palte heart oh ought. His
      ...
      <div className="gpt3__whatgpt3-container">
        <Feature 
          ...
          text="We so opinion friends me message as
                delight. Whole front do of plate heart oh ought."
        />
        <Feature 
          title="knowledgebase"
          text="At jointure ladyship an insisted so humanity
